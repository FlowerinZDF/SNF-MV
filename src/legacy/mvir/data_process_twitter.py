...
data_path = '/hy-tmp/lhc/Reproduction_of_MCAN-main-Twitter/twitter_dataset'
new_train = '/hy-tmp/lhc/Reproduction_of_MCAN-main-Twitter/processd_data/twitter/train.txt'
new_test = '/hy-tmp/lhc/Reproduction_of_MCAN-main-Twitter/processd_data/twitter/test.txt'

# data_path = '/home/xxxx/Reproduction_of_MCAN/twitter_dataset'
# new_train = '/home/xxxx/Reproduction_of_MCAN/processd_data/twitter/train.txt'
# new_test = '/home/xxxx/Reproduction_of_MCAN/processd_data/twitter/test.txt'
#
image_file_list = [os.path.join(data_path, 'devset/images/'),
                   os.path.join(data_path, 'testset/images/')]
...
if __name__ == '__main__':
    ...
    new_train = '/hy-tmp/lhc/Reproduction_of_MCAN-main-Twitter/processd_data/twitter/train.txt'
    # new_test = './processd_data/twitter/test.txt'
