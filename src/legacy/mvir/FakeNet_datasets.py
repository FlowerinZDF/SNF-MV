...
class FakeNet_dataset(data.Dataset):
    ...
    def __init__(
            self, root_path='/hy-tmp/lhc/gossip/AAAI_dataset', dataset='gossip',
...
# token_uncased = BertTokenizer.from_pretrained('H:\Bert/bert-base-uncased')
...
#                                 not_on_12=0,
#                                 )
# train_loader = DataLoader(train_dataset, batch_size=2, shuffle=True, collate_fn=collate_fn_english,
#                           num_workers=0, sampler=None, drop_last=True,
#                           pin_memory=True)
#
