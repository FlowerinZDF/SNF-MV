"""Training entry for the first runnable Weibo global fake/real baseline."""
...
@torch.no_grad()
def evaluate(model: GlobalModel, dataloader: DataLoader, device: torch.device) -> dict[str, float | int]:
    model.eval()
...
def run_training(args: argparse.Namespace) -> dict[str, Any]:
    ...
    ckpt_path = out_dir / "global_model_best.pt"
    torch.save(
        {
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Train global fake/real baseline on Weibo JSONL")
    ...
    parser.add_argument("--output-dir", default="outputs/global_baseline", help="Output directory")
