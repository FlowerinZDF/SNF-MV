"""Smoke test for first runnable full SNF-MV consistency stage."""
...
from src.trainers.train_full import run_training


class TestFullModelStage1(unittest.TestCase):
